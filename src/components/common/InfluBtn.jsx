...
function InfluBtn(
    ...
    const baseStyles='inline-flex items-center rounded-lg transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed';
    const variants ={
