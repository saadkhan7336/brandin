  ...
  return (
    <div className="min-h-screen bg-[#f8f9fc] flex flex-col items-center justify-center p-4 font-sans">
      ...
      <div className="w-full max-w-[440px] bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-10 pb-8 flex flex-col items-center relative overflow-hidden">
        ...
        <h1 className="text-[26px] font-extrabold text-[#111827] mb-3 text-center tracking-tight">
        ...
        <div className="mb-6 flex flex-col items-center">
          <span
            className={`text-xl font-bold ${isExpired ? "text-red-500" : "text-[#1a56db]"}`}
          >
            {formatTime(timeLeft)}
          </span>
          {isExpired && (
        ...
        >
          ...
          {successMsg && (
            <p className="text-green-600 text-sm mb-4 font-medium text-center">
              {successMsg}
            </p>
          )}
          ...
          <div className="flex gap-4 justify-center items-center pb-2">
            <div className="w-6 h-6 bg-[#9ca3af] rounded flex items-center justify-center text-white text-[10px] font-bold opacity-80">
              A
            </div>
            <div className="w-6 h-6 bg-[#9ca3af] rounded flex items-center justify-center text-white text-[10px] font-bold opacity-80">
              B
